	...
	public function __construct (){ 
		...
		if (is_array($feld)){
			for ($a=0; $a < count($feld); $a++){
				...
				if ($feld[$a][5]!=0 && $feld[$a][6]==$_SESSION['etchat_'.$this->_prefix.'user_id']) echo "<tr class=\"privat_von\" id=\"tr".$feld[$a][0]."\"  >";
				if ($feld[$a][5] == $_SESSION['etchat_'.$this->_prefix.'user_id']) echo "<tr class=\"privat_nach\" id=\"tr".$feld[$a][0]."\"  >";
				echo "
